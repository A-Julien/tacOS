...
///
///      @param "func" is the procedure to run concurrently.
///      @param "arg" is a single argument to be passed to the procedure.
///
...
///              calls Thread::Finish
///
///     @param "func" is the procedure to be forked
///     @param "arg" is the parameter to be passed to the procedure
///
