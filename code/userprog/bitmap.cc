/**
 * @file bitmap.c
 * @brief Routines to manage a bitmap -- an array of bits each of which
...
///
///     @param[in] "nitems" is the number of bits in the bitmap.
///
...
///
///     @param[in] which is the number of the bit to be set.
///
...
///
///     @param[in] "which" is the number of the bit to be cleared.
///
...
///
///    @param[in]  "which" is the number of the bit to be tested.
///
...
///
/// BitMap::NumClear
///      @return Return the number of clear bits in the bitmap.
...
*       @param[in] file is the place to read the bitmap from
*/
void
