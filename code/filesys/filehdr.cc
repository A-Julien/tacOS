...
///	@return Return FALSE if there are not enough free blocks to accomodate the new file.
///
...
/// 	@return Return which disk sector is storing a particular byte within the file.
